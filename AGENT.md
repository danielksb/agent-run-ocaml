...
- **File Structure:**
  - `bin/` – Defines executable CLI tool, uses lib
  - `lib/` – library for reading config and handling the LLM agents
  - `lib/tools` – contains all agentic tools
...
- Always run the code formatter after editing files.
